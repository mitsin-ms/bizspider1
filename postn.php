...
<body onload = "funconload()">
    ...
    <div class="row"> 
        ...
        <div class="col-md-4">
            <div class="lform" >
                <div id="forme"></div>
                <form method="post" action="postnp.php" enctype = "multipart/form-data" name="formprofile" id="formprofile1" data-parsley-validate>
                    <input style='display:none;' type = "text" name="custid" value = "<?php echo $idmain; ?>" readonly >
                    <!--style="display:none;"-->
                    
                    
                    <div class="form-group">
                    <label for="Title">Title :</label>
                    <input type="text" class="form-control" id="title1" name="title1" data-parsley-required>
                    </div>
                    <br>
                    <label for="description">Description</label>
                    <br>    
                    <textarea name = "description" rows= '4' cols = '55' id ="description" data-parsley-required></textarea>
                    <br>
                    <label for="image1">Please select image for the post</label>
                    <input type="file" name="fileToUpload" onchange="preview_image(event)">
                    <div id="picture1">
                    <img alt="image" style="width:100px; height:100px" id="output_image">
                    </div>
