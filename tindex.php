...
<html>
 ...
 -->
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto"  id="morespaceinnavbar">
            ...
            <li class="nav-item">
              <a class="nav-link nav1" href="#">Contact</a>
            </li>
            <li class="nav-item">
               <a class="nav-link nav1" href="#" onclick="funclogout()"><?php echo "logout($username)" ?>;</a>  
            </li>  
          </ul>
        </div>
      </div>
    ...
    <div class="fullwidthimage">
      ...
      <h1>.</h1>
      <h1>.</h1>    
      <h1 class="lettersh1"> WE ARE <span id= "demo1" >yy</span></h1>
      <span class="main-element themecolor" data-elements="Web Developers,Creative,Ambitious">Web Developers</span>    
      <h4 class="lettersh11">By using strategic approach we design, build & market a creative solution which will give strongest impact.</h3>
      <h4 class="lettersh11">lets work together on so meeting spectacular for your business because</h3>
            ...
            <div class="col">
              ...
              <div class="col">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title text-center font-weight-bold">KingMaker</h5>  
                  </div>
                </div>
             </div>
            </div>
...
<script>
    ...
    window.addEventListener("onload",myfunc());
    ...
    while(c < var1.length){
        ...
        str = str+var1.substr(c,1);
     //alert(str);
     document.getElementById("demo1").innerHTML += var1.charAt(c);
     var delay = 100000;
     myVar = setTimeout(myfunc, 5000);
     //alert("aftersettimeout");    
//    
//    var d = 0;
//    while(d<delay){
//        d++;
//    }
    ...
    function myfunc1() {
        ...
        var2[0]="AMBITIOUS";
        var2[1]="CREATIVE";
        var2[2]="WEB DEVELOPERS";
        while(e<20) {
        alert("in timer");    
        setTimeout(myfunc(var2[f]),3000);
        e=e+1;
        f = f+1;
        if(f>3){
            f = 1;
